...
suite("Functional Tests", () => {
  ...
  test("Solve a puzzle with invalid characters: POST request to /api/solve", (done) => {
    let invalidPuzzle =
      "1.5..2.84..63.12.7.2..5.....9..1....8.2.3i74.3.7.2..9.47...8..1..16....926914.37.";
    chai
      .request(server)
      .post("/api/solve")
  ...
  test("Solve a puzzle with incorrect length: POST request to /api/solve", (done) => {
    let invalidPuzzle =
      "1...2.84..63.12.7.2..5.....9..1....8.2.3i74.3.7.2..9.47...8..1..16....926914.37.";
    chai
      .request(server)
      .post("/api/solve")
      .send({ puzzle: invalidPuzzle })
  ...
  test("Check a puzzle placement with invalid characters: POST request to /api/check", (done) => {
    let invalidPuzzle =
      "1.5..2.84..63.12.7.2..5..m..9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.";
    chai
      .request(server)
      .post("/api/check")
  ...
  test("Check a puzzle placement with incorrect length: POST request to /api/check", (done) => {
    let invalidPuzzle =
      ".5..2.84..63.12.7.2..5..h..9..1..8.2.3674.3.7.2..9.47...8..1..16....926914.37.";
    chai
      .request(server)
      .post("/api/check")
